...
| 工具 | 简介 | 分类 | 日期 |
|------|------|------|------|
| [Airbyte Agents](https://airbyte.com/agents) | AI Agent 跨数据源获取上下文 | Agent | 05-09 |
| [DAC](https://github.com/bruin-data/dac) | Dashboard as Code，Agent 友好的数据看板 | 开发工具 | 05-09 |
